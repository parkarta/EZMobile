...
NATIVE	i, j;
HNATIVE	u;			// m = T[0] + u * A[0] * B[j] where u = -P[0]^(-1) (mod r) = 1 with our P
HNATIVE	ext;		// It is used instead of T[BNHWORDS]
HNATIVE	t;			// Multiplication carry < r
WORDv	C;			// Reduction carry < r^2
NATIVE	V;
HNATIVE	*A = (HNATIVE *) &Mult1;
HNATIVE	*B = (HNATIVE *) &Mult2;
HNATIVE	*T = (HNATIVE *) &Result;
...
}	// static void MulMont(const HNATIVE * A, const HNATIVE * B, HNATIVE * T)
